...
export const INTENT_MAPPINGS = [
  ...
  },
  {
    ...
    weak: ['tax_illinois_estate', 'tax_federal_estate', 'access_fixed_income', 'access_liberal_discretionary', 'constraint_creditor_protection'],
    incompatible: ['fund_annual_gift_exclusion', 'start_during_life'],
    caveats: [
  ...
  },
  {
    ...
    strong: [
      ...
      'start_at_my_death',
      'access_hems_ascertainable',
      'access_liberal_discretionary',
      'constraint_creditor_protection',
    ],
  ...
  },
  {
    ...
    weak: ['access_staged_ages', 'remainder_to_children', 'beneficiary_children', 'constraint_creditor_protection', 'access_liberal_discretionary'],
  ...
  },
  {
    ...
    strong: ['constraint_ira_assets', 'constraint_creditor_protection', 'access_hems_ascertainable'],
